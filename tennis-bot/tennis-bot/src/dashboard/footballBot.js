...
function handleGetBetsCsv(req, res) {
  try {
    ...
    const cols = [
      'id', 'placedAt', 'settledAt', 'strategy', 'signalStrategy',
      'teamA', 'teamB', 'match', 'league', 'startDate',
      'betfairEventId', 'marketId', 'selectionId', 'marketName',
      'overUnderValue', 'overOdds', 'underOdds',
      'timer', 'goalsA', 'goalsB', 'goals',
      'result', 'finalGoals', 'finalGoalsA', 'finalGoalsB',
      'avePoints', 'success', 'isCompanion',
      'historical', 'historicalSheet', 'historicalSource',
    ];

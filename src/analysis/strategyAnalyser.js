...
module.exports = {
  runAnalysis, getHistory, getCached, chat,
  // Reusable context builders shared with aiChat.js (additive — do not remove).
  buildDataSummary:        _buildDataSummary,
  formatForPrompt:         _formatForPrompt,
  buildDeepData:           _buildDeepData,
  formatDeepDataForPrompt: _formatDeepDataForPrompt,
  CHAT_SYSTEM,
};
